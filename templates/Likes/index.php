                ...
                <?php foreach ($likes as $like) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $like->photo_id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $like->photo_id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
